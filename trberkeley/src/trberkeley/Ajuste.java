...
public class Ajuste {
    ...
    public void sincronizar(Relogio servidor, Relogio clientes[]) {
        ...
        //Criando espaco para guardar as horas convertidas em minutos para calculo
        int convServ = hour2minutes(servidor.hora);
        int[] converte = new int[3];
        
        //Covertendo as horas dos cliente p/minutos
        //Inserindo as diferencas com o servidor
        //Somando as diferencas para depois calcular media
